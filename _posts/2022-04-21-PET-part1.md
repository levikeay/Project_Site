...
2. **Experiment setup**
   ...
   2.1. **Hardware**
   2.2. **Key system parameters and their impact on image resolution**
...
|:--:|
|Sinogram and image displaying crescent shaped distortion of two radiation sources. The axes are not formatted, see the following figure.|
