...
**Linear and rotational step sizes** will influence **spatial resolution** of the formed image, while **exposure time** will influence the **radiometric resolution**, or contrast, of the final image. The **aperture** effects image **sharpness**, by controlling **image blur** that arises due to the permiability of the copper aperture gates and the geometry of the imaging area.

The diagram below demonstrates the relationship between image blur and aperture width for the imaging of a single radiation source.
...
In order to reconstruct an image, scans were taken at many angles, and a sinogram was constructed. The 2 dimensional image of the radiation distribution was retrieved from the sinogram by means of the inverse radon transform.
