...
Using automated step-motors interfacing with the lab computer, the radiation source is moved along the track in incremental steps, and held in place while the count is recorded onto the lab computer. 
